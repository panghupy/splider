...
# 获取到文章div列表，包含标题和url
content_div_list = result.xpath('//div[@class="content"]')
for content_div in content_div_list:
    title = content_div.xpath('./a/text()')[0]
    url = 'https://www.jianshu.com' + content_div.xpath('./a/@href')[0]
    # 获取到了url：文章详情链接
    print(title, url)
